 ...
 * @LastEditTime: 2021-01-27 17:15:11
 * @LastEditors: Leo
-->
<template>
    ...
    openDetails(teamId) {
      getTeamDetail({ teamId }).then((res) => {
        ...
        if (result.code === 0) {
          ...
          this.infoData.imgURL = result.data.team.teamLogoPath;
          this.infoData.teamId = result.data.team.id;
          this.infoData.hockeyGamesId = this.form.hockeyGamesId;
